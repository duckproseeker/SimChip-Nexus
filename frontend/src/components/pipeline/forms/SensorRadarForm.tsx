...
export function SensorRadarForm({ data, onChange }: Props) {
  return (
    <div className="flex flex-col gap-3">
      {textField('sensor_id', '传感器 ID', 'radar_front', data, onChange)}
      ...
      {numField('horizontal_fov', '水平视角 (°)', data, onChange, 1)}
      {numField('vertical_fov', '垂直视角 (°)', data, onChange, 1)}
