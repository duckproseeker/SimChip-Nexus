    ...
    xosc_path.write_text(
        "\n".join(
            [
                ...
                '    <ParameterDeclaration name="leadingSpeed" parameterType="double" value="5.5"/>',
                '    <ParameterDeclaration name="travelDistance" parameterType="double" value="200.0"/>',
                "  </ParameterDeclarations>",
                ...
                "                  <Properties>",
                '                    <Property name="target_speed_mps" value="$heroSpeed"/>',
                "                  </Properties>",
                "                </Controller>",
                "              </AssignControllerAction>",
                "            </ControllerAction>",
                ...
                "                </TriggeringEntities>",
                "                <EntityCondition>",
                '                  <TraveledDistanceCondition value="$travelDistance"/>',
                "                </EntityCondition>",
                "              </ByEntityCondition>",
                "            </Condition>",
                "          </ConditionGroup>",
