...
class WorkflowStepReadiness(BaseModel):
    step: str
    label: str
    ready: bool
...
class WorkflowReadinessPayload(BaseModel):
    project_id: str | None
    benchmark_definition_id: str | None
    scenario_id: str | None
    steps: list[WorkflowStepReadiness]
    next_step: WorkflowStepReadiness | None
    all_ready: bool


class WorkflowReadinessResponse(ApiResponse[WorkflowReadinessPayload]):
    pass
